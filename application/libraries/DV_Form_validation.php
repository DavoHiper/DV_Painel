 ...
 *
 */
class DV_Form_validation extends CI_Form_validation {
     ...
     * @return	bool
     */
    function less_date($date, $field) {
        $CI = & get_instance();
        $CI->form_validation->set_message('less_date', 'A %s deve ser maior que xxxx.');

        print_r($CI->input->post($field));
